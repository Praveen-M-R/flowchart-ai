...
class Repository(CompletableGithubObject):
    ...
    def url(self) -> str:
        if (
            is_undefined(self._url)
            and is_defined(self._owner)
            and is_defined(self._name)
        ):
    ...
    def compare(self, base: str, head: str) -> Comparison:
        ...
        headers, data = self._requester.requestJsonAndCheck(
            "GET", f"{self.url}/compare/{base}...{head}", params
        )
    ...
    def create_repository_advisory(
        ...
        vulnerabilities: (
            Iterable[github.AdvisoryVulnerability.AdvisoryVulnerabilityInput] | None
        ) = None,
    ...
    def create_secret(
        ...
        self._requester.requestJsonAndCheck(
            "PUT",
            f"{self.url}/{secret_type}/secrets/{secret_name}",
    ...
    def get_hook_deliveries(
        self, hook_id: int
    ) -> PaginatedList[github.HookDelivery.HookDeliverySummary]:
        """
    ...
    def get_workflow(self, id_or_file_name: str | int) -> Workflow:
        ...
        headers, data = self._requester.requestJsonAndCheck(
            "GET", f"{self.url}/actions/workflows/{id_or_file_name}"
        )
    ...
    def create_environment(
        ...
        put_parameters = {
            ...
            "deployment_branch_policy": (
                deployment_branch_policy._asdict() if deployment_branch_policy else None
            ),
        }
