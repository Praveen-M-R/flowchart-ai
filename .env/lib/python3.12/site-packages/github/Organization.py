...
class Organization(CompletableGithubObject):
    ...
    def _initAttributes(self) -> None:
        ...
        self._secret_scanning_push_protection_custom_link_enabled: Attribute[bool] = (
            NotSet
        )
    ...
    def create_secret(
        ...
        self._requester.requestJsonAndCheck(
            "PUT",
            f"{self.url}/{secret_type}/secrets/{urllib.parse.quote(secret_name)}",
    ...
    def get_variable(self, variable_name: str) -> OrganizationVariable:
        ...
        return github.OrganizationVariable.OrganizationVariable(
            ...
            headers={},
            attributes={
                "url": f"{self.url}/actions/variables/{urllib.parse.quote(variable_name)}"
            },
            completed=False,
        )
